...
export const fallbackServices: any[] = [
  {
    id: 1,
    title: "Residential Design",
    description:
      "Transform your living spaces with our custom interior design services tailored for homes and apartments.",
  ...
  },
  {
    ...
    description:
      "Create inspiring work environments with our commercial interior design services for offices and retail spaces.",
  ...
  },
  {
    ...
    description:
      "Optimize your space with professional planning that maximizes functionality and enhances flow.",
...
export const fallbackProjects: any[] = [
  {
    id: 1,
    title: "Contemporary Apartment",
    description:
      "A sleek, modern design for a high-rise apartment with panoramic city views.",
  ...
  },
  {
    ...
    description:
      "Complete interior transformation of a luxury villa with custom furniture and unique décor elements.",
  ...
  },
  {
    ...
    description:
      "A collaborative office environment designed for productivity and employee well-being.",
  ...
  },
  {
    ...
    description:
      "Elegant retail space designed to enhance product display and customer experience.",
  ...
  },
  {
    ...
    description:
      "Clean lines and thoughtful design create a peaceful, minimalist living space.",
  ...
  },
  {
    ...
    description:
      "A complete overhaul of dining space to create an immersive culinary experience.",
...
export const fallbackTransformations: any[] = [
  {
    id: 1,
    title: "Kitchen Renovation",
    description:
      "Transformed an outdated kitchen into a modern cooking space with premium appliances and elegant finishes.",
  ...
  },
  {
    ...
    description:
      "Converted a dark, cramped living area into a bright, open space perfect for family gatherings.",
...
export const fallbackTeamMembers: any[] = [
  {
    id: 1,
    name: "Rohan Rao",
