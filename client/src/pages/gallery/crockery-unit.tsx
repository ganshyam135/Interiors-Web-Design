...
export default function CrockeryUnitGallery() {
  const [selectedImageIndex, setSelectedImageIndex] = useState<number | null>(null);
  const images = getGalleryImagesWithPlaceholders('crockery-unit');
    ...
    <>
      ...
      <section className="bg-cream dark:bg-cream-dark py-20 md:py-28">
        <div className="container-custom">
          <div className="text-center">
            <h1 className="text-4xl md:text-5xl font-serif mb-6 text-charcoal dark:text-charcoal-light">Crockery Unit Designs</h1>
            <p className="text-lg text-darkgray dark:text-darkgray-light max-w-2xl mx-auto mb-8">
              Discover our exquisite crockery unit designs that combine functionality with elegance for perfect dining storage solutions.
            </p>
      ...
      <section className="py-20 md:py-28 bg-charcoal dark:bg-gray-800 text-white">
        <div className="container-custom">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-serif mb-6">Love These Luxury Crockery Unit Designs?</h2>
            <p className="text-lg mb-8">
              Experience the perfect blend of elegance and storage functionality. Contact us to create a bespoke crockery unit with premium materials, sophisticated finishes, and thoughtful organization.
            </p>
      ...
      {selectedImageIndex !== null && (
        <ImageModal
          ...
          imageAlt={`Crockery Unit Design ${selectedImageIndex + 1}`}
