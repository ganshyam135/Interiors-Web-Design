      ...
      <section className="bg-cream dark:bg-cream-dark py-20 md:py-28">
        <div className="container-custom">
          <div className="text-center">
            <h1 className="text-4xl md:text-5xl font-serif mb-6 text-charcoal dark:text-charcoal-light">Pooja Room Designs</h1>
            <p className="text-lg text-darkgray dark:text-darkgray-light max-w-2xl mx-auto mb-8">
              Create a sacred and serene space for worship with our thoughtfully designed pooja room interiors.
            </p>
      ...
      <section className="py-20 md:py-28 bg-charcoal dark:bg-gray-800 text-white">
        <div className="container-custom">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-serif mb-6">Love These Pooja Room Designs?</h2>
            <p className="text-lg mb-8">
              Get in touch with us to create a custom pooja room design that brings peace and spirituality to your home.
            </p>
