...
export default function TVUnitGallery() {
  ...
  const images = getGalleryImages('tv-unit');
    ...
    <>
        ...
        <div className="container-custom">
          <div className="text-center">
            ...
            <p className="text-lg text-darkgray dark:text-darkgray-light max-w-2xl mx-auto mb-8">
              Browse our portfolio of custom TV unit designs and entertainment centers.
            </p>
      ...
      <section className="py-20 md:py-28 bg-charcoal dark:bg-gray-800 text-white">
        <div className="container-custom">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-serif mb-6">Love These Luxury TV Unit Designs?</h2>
            <p className="text-lg mb-8">
              Experience the perfect blend of elegance and functionality. Contact us to create a bespoke TV unit with premium materials, geometric patterns, and sophisticated finishes.
            </p>
      ...
      {selectedImageIndex !== null && (
        <ImageModal
          ...
          imageAlt={`TV Unit Design ${selectedImageIndex + 1}`}
